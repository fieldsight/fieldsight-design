		  					...
		  					<div class="row no-gutters bg-primary">
		  						<div class="col-lg-5">
		  							<div class="sec-left text-center bg-white">
		  								...
		  								FieldSight is the first humanitarian digital platform designed for project monitoring and infrastructure quality assurance. The platform is now being used to monitor more than <strong> 50,000 </strong> houses.
		  								</p>
		  							</div>
		  						</div>
		  						<div class="col-lg-7">
		  							<div class="sec-right">
										...
										<div class="tab-content" id="pills-tabContent">
											<div class="tab-pane fade show active" id="pills-login" role="tabpanel" aria-labelledby="pills-login-tab">
												<form autocomplete="off">
												  	...
												  	<div class="form-group">
												    	...
												    	<div class="input-group input-pass-showhide">	<input type="password" class="form-control" id="inputPassword" placeholder="e.g., **********">
												  	...
												  	<ul class="list-inline">
												  		...
												  		<!-- <li class="list-inline-item">
												  			<button type="submit" class="btn btn-secondary" data-toggle="tooltip" data-placement="bottom" title="Signin with Facebook"><i class="la la-facebook"></i></button>
												  		</li> -->
												  		<li class="list-inline-item">
												  			<button type="submit" class="btn btn-secondary" ><i class="la la-google"></i> Signin with Google</button>
												  		</li>
												  	</ul>
												</form>
											</div>
											<div class="tab-pane fade" id="pills-signup" role="tabpanel" aria-labelledby="pills-signup-tab">
												<form>
													...
													<div class="form-group">
													    ...
													    <div class="input-group input-pass-showhide">
															<input type="text" class="form-control" id="inputSignupPassword" placeholder="e.g., **********">
													...
													<!-- <div class="form-group">
													    ...
													    <div class="input-group input-pass-showhide">
															...
															<div class="input-group-append" data-placement="bottom" title="Hide/Show Password">
														    	<span class="input-group-text"><i class="la la-eye"></i></span>
														  	</div>
														</div>
													</div> -->
													...
													<ul class="list-inline">
												  		...
												  		<li class="list-inline-item">or</li>
												  		<!-- <li class="list-inline-item">
												  			<button type="submit" class="btn btn-secondary" data-toggle="tooltip" data-placement="bottom" title="Signup with Facebook"><i class="la la-facebook"></i></button>
												  		</li> -->
												  		<li class="list-inline-item">
												  			<button type="submit" class="btn btn-secondary"><i class="la la-google"></i> Signup with Google</button>
												  		</li>
												  	</ul>
												</form>
											</div>
											...
											<div class="tab-pane fade" id="pills-reset" role="tabpanel" aria-labelledby="pills-reset-tab">
													...
													<button type="button" class="btn btn-secondary" id="btn-resetpassword"><i class="la la-send" ></i> Submit</button>
