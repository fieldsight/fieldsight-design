					...
					<div class="action-right">
						<span class="dropdown">
							...
							<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButtonManage">
								...
								<a class="dropdown-item" href="#"><i class="la la-edit"></i> Organization</a>
							</div>
						</span>
					</div>
				</div>
							...
							<div class="col-lg-6 col-sm-12">
								<div class="org-profile-basic-info-left clearfix ">
									...
									<div class="org-profile-basic-info">
										<h2>Field Sight Organization</h2>
										<p>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-sm-12">
							<div class="widget-info widget-scrolling-large-list margin-top bg-white padding">
								<div class="widget-head">
									<h4>Projects</h4>
									<a class="btn btn-xs btn-primary" data-toggle="modal" href="#addProject" data-target="#projectModal"><i class="la la-plus"></i></a>
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-footer">
													<button type="button" class="btn btn-sm btn-primary"><i class="la la-plus"></i> Add Project</button>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-12">
							<div class="widget-info margin-top bg-white padding" data-mh="row-1">
								<div class="widget-head">
									<h4><a href="#" title="">Contact Info</a></h4>
								</div>
								<div class="widget-body">
						...
						<div class="col-lg-4 col-md-12">
							<div class="widget-info widget-scrolling-list margin-top bg-white padding" data-mh="row-1">
										<div class="widget-head">
											...
											<div class="modal fade" id="adminModal" tabindex="-1" role="dialog" aria-labelledby="projectModalLabel" aria-hidden="true">
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														<div class="modal-header">
															<h5 class="modal-title" id="projectModalLabel">New Admin</h5>
															<button type="button" class="close" data-dismiss="modal" aria-label="Close">
															  <span aria-hidden="true">&times;</span>
															</button>
														</div>
														...
														<div class="modal-footer">
															<button type="button" class="btn btn-sm btn-primary"><i class="la la-plus"></i> Add Admin</button>
															<button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal">Close</button>
														</div>
													</div>
												</div>
