...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    ...
    <body>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="margin-top user-profile-basic-info padding bg-white clearfix ">
								<div class="media">
									<img class="d-flex align-self-start mr-3"  src="assets/img/img-avatar.jpg" alt="Generic placeholder image">
									<div class="media-body">
										<h2 class="margin-top">Bikrant Giri</h2>
										<div class="row">
											<div class="col-lg-4">
											...
											<div class="col-lg-4">
												<div class="contact-info-item margin-top" data-mh="eq-item">
													<i class="la la-envelope-o"></i> <strong>Email</strong><br/>info@domainname.com
												</div>
											</div>
											<div class="col-lg-4">
												<div class="contact-info-item margin-top" data-mh="eq-item">
											...
											<div class="col-lg-4">
												<div class="contact-info-item margin-top" data-mh="eq-item">
													<i class="la la-certificate"></i> <strong>Designation</strong><br/>Manager
												</div>
											</div>
											<div class="col-lg-4">
												<div class="contact-info-item margin-top" data-mh="eq-item">
		...
		<script src="assets/js/vendor/calendar.min.js"></script>
		<script>
			(function($) {
				"use strict";
